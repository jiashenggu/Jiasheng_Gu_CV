...
&  \begin{itemize}[leftmargin=10pt, itemsep=-5pt, topsep=0pt,before=\textbf{North Carolina State University}]
    ...
    \item Publication: EMNLP workshop in prep
  \end{itemize}\\ 
&  \begin{itemize}[leftmargin=10pt, itemsep=-5pt, topsep=0pt,before=\textbf{Shanghai Jiaotong University}]
    ...
    \item Project: Training Large Language Model on Math Tasks
...
&  \begin{itemize}[leftmargin=10pt, itemsep=-5pt, topsep=0pt,before=\textbf{University of Southern California}]
    \item Mentor: \href{https://usc-isi-i2.github.io/szekely/}{Pedro Szekely} \href{https://usc-isi-i2.github.io/ilievski/}{Filip Ilievski}\hfill Jan. 2022 - May. 2022
...
&  \begin{itemize}[leftmargin=10pt, itemsep=-5pt, topsep=0pt,before=\textbf{Lime}]
    ...
    \item Refactored a system for timed feature extraction and computation for enhanced scalability. Optimized the process of timed computation, resulting in significant improvement in the overall system efficiency.
  \end{itemize}\\ 
...
&  \begin{itemize}[leftmargin=10pt, itemsep=-5pt, topsep=0pt,before=\textbf{Transwarp}]
    ...
    \item  Established a long text summarization system with an extractive-abstractive structure, with DGCNN for extractive summarization and BART for abstractive summarization.
  \end{itemize}\\ 
...
&  \begin{itemize}[leftmargin=10pt,topsep=0pt,before=\textbf{Program Committee}]
    ...
    \item Conference on Empirical Methods in Natural Language Processing \hfill 2023
  \end{itemize}\\ 
...
&  xshen5@ncsu.edu \\
\\
& \textbf{\href{http://pfliu.com/}{Pengfei Liu}, Assistant Professor}\\
